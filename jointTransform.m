...
T = zeros(4,4)
	T(1,1) = cos(joint.DH.theta);	T(1,2) = -sin(joint.DH.theta)*cos(joint.DH.alpha);		T(1,3) = sin(joint.DH.theta)*sin(joint.DH.alpha);			T(1,4) = joint.DH.a*cos(joint.DH.theta);
	T(2,1) = sin(joint.DH.theta);	T(2,2) = cos(joint.DH.theta)*cos(joint.DH.alpha);		T(2,3) = -cos(joint.DH.theta)*sin(joint.DH.alpha);		T(2,4) = joint.DH.a*sin(joint.DH.theta);
