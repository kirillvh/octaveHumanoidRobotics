...
for y = 0:0.01:DOF*0.2
    ...
    jointAnglesRef = IK(M.joints, position_ref, 'maxiter', 100, 'kX', 0.5, 'maxposerr', 0.001, 'mode', 'transp','ikMode','com');
...
for y = 0:0.01:DOF*0.2
    ...
    jointAnglesRef = IK(M.joints, position_ref, 'maxiter', 100, 'kX', 0.5, 'maxposerr', 0.001, 'mode', 'pinv','ikMode','com');
...
for y = 0:0.01:DOF*0.2
    ...
    jointAnglesRef = IK(M.joints, position_ref, 'maxiter', 100, 'kX', 1, 'maxposerr', 0.001, 'mode', 'dls','ikMode','com');
